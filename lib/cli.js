...
function showHelpOptions() {
  /* quick and dirty */
  var help = [
    "  Usage: yuidoc [options]\n",
    "    -c, --config, --configfile    Path to your config file, based on ./package.json",
    "    -e, --extension               File extension(s) to use for parsing, defaults to '.js'",
    "    -x, --exclude                 Extensions to exclude from parsing",
    "    -v, --version                 the YUIDoc JS version",
    "    -n, --norecurse               Do not recursively search folders",
    "    -o, --outdir                  Directory to output to, defaults to './out'",
    "    -t, --themedir                A custom theme directory",
    "\nFor more documentation, please refer to https://github.com/davglass/yuidocjs",
    "Exiting\n"
  ]
